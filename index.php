...
<head>
    ...
    <title>Asana | <?php echo count($today) ?> Global View </title>
...
//]]></script>
    ...
    <div class="menu" id="sidebar">
        ...
        <label class="show-completed"><input type="checkbox" value=""> Afficher les tâches complétées aujourd'hui</label>
    </div>
        ...
        <div class="container">
            <div class="row row-tasks">
                <div class="column col-md-3 col-sm-6">
                    <h2 class="list-title">Aujourd'hui</h2>
                ...
                <div class="column col-md-3 col-sm-6">
                    <h2 class="list-title">Cette semaine</h2>
                ...
                <div class="column col-md-3 col-sm-6">
                    <h2 class="list-title">Plus tard</h2>
                ...
                <div class="column col-md-3 col-sm-6">
                    <h2 class="list-title">Boîte de réception</h2>
    ...
    <footer>
        <div class="container">
            <div class="row new-task-form">
                <div class="form-group">
                    <div class="col-lg-3 workspace">
                        <!-- Workspace -->
                        <label for="workspace-sel">Organisation:</label>
                        <select class="form-control" id="workspace-sel">
                            <?php foreach ($workspaces as $workspace) {
                                echo '<option value="'.$workspace['gid'].'">'.$workspace['name'].'</option>';
                            }?>
                        </select>                        
                    </div>
                    <div class="col-lg-3 project">
                        <!-- Project -->
                        <label for="project-sel">Projet:</label>
                        <select class="form-control" id="project-sel">
                        </select>
                    </div>
                    <div class="col-lg-3 title">
                        <!-- Title -->
                        <label for="title-sel">Tâche:</label>                    
                    ...
                    <div class="col-lg-3 assignee">
                        ...
                        <a href="create" class="btn btn-info new-task">Créer</a>
                        <!-- Loader -->
            ...
            <a href="https:www.tonadjointecreative.ca">created by How About Yes - Remastered by Ton Adjointe Créative</a>
        </div>
    </footer>
